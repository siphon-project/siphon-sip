...
pub(crate) fn profile_flags_from_ng(flags: &NgFlags) -> ProfileFlags {
    ProfileFlags {
        ...
        echo_delay_search_ms: flags.echo_delay_search_ms,
        echo_long_tail: flags.echo_long_tail,
        echo_residual_suppression: flags.echo_residual_suppression,
